                        ...
                        <ul>
                            <li>
                                <div class="category-list">
                                    <img src="/template/svg/1/vegetable.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="/template/svg/1/cup.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="/template/svg/1/meats.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="/template/svg/1/breakfast.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="/template/svg/1/frozen.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="/template/svg/1/biscuit.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="/template/svg/1/grocery.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="/template/svg/1/drink.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="/template/svg/1/milk.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="/template/svg/1/pet.svg" class="blur-up lazyload" alt="">
                                    <h5>
                    ...
                    <div class="row row-cols-xxl-5 row-cols-xl-4 row-cols-md-3 row-cols-2 g-sm-4 g-3 no-arrow
                            ...
                            <div class="product-box product-white-bg wow fadeIn">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="/template/images/cake/product/3.png"
                        ...
                        <div>
                            <div class="product-box product-white-bg wow fadeIn" data-wow-delay="0.1s">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="/template/images/cake/product/4.png"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                        ...
                        <div>
                            <div class="product-box product-white-bg wow fadeIn">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="/template/images/cake/product/5.png"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                        ...
                        <div>
                            <div class="product-box product-white-bg wow fadeIn" data-wow-delay="0.1s">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="/template/images/cake/product/6.png"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                        ...
                        <div>
                            <div class="product-box product-white-bg wow fadeIn">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="/template/images/cake/product/7.png"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                        ...
                        <div>
                            <div class="product-box product-white-bg wow fadeIn" data-wow-delay="0.1s">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="/template/images/cake/product/8.png"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                        ...
                        <div>
                            <div class="product-box product-white-bg wow fadeIn">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="/template/images/cake/product/9.png"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                        ...
                        <div>
                            ...
                            <div class="product-box product-white-bg wow fadeIn" data-wow-delay="0.1s">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="/template/images/cake/product/10.png"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                    ...
                    <div class="row row-cols-xxl-5 row-cols-xl-4 row-cols-md-3 row-cols-2 g-sm-4 g-3 no-arrow">
                        <div>
                            <div class="product-box product-white-bg wow fadeIn">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="/template/images/cake/product/1.png"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                        ...
                        <div>
                            <div class="product-box product-white-bg wow fadeIn" data-wow-delay="0.1s">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="/template/images/cake/product/2.png"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
